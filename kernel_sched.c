...
/* Timeslice counter for boosting procceses*/
uint64_t timeslices = 0;
// Mutex timeslices_spinlock = MUTEX_INIT;

/* Timeslices after which to boost all proccesses*/
#define TIMESLICE_BOOST 50
...
TCB* spawn_thread(PCB* pcb, void (*func)())
{
	...
	/* ssshhh! some cheating is fine */
	memset(tcb, 0, THREAD_SIZE);
